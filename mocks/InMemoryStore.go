...
// InMemoryStore is an autogenerated mock type for the InMemoryStore type
type InMemoryStore struct {
	mock.Mock
}

// GetData provides a mock function with given fields: key
func (_m *InMemoryStore) GetData(key string) (*types.KeyValue, *errors.AppError) {
	ret := _m.Called(key)
...
func (_m *InMemoryStore) PutData(kv *types.KeyValue) *types.KeyValue {
	ret := _m.Called(kv)
